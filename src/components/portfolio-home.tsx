...
export function PortfolioHome({projects,testimonials,writing}:{projects:Project[];testimonials:Testimonial[];writing:WritingItem[]}) {
  ...
  return <>
    <main id="main">
      <section className="hero-section" aria-labelledby="hero-title"><div className="hero-atmosphere"/><div className="page-shell hero-inner"><p className="hero-kicker"><span/>Nayana Kumari · AI Product Manager</p><h1 id="hero-title"><span>AI Product Manager</span> turning complex AI workflows into products people adopt.</h1><p className="hero-role-line">4 years across 0→1 launches, growth, and enterprise workflows.</p><p className="hero-copy">I turn ambiguous customer and technical problems into shipped products, measurable adoption, and revenue.</p><div className="hero-actions"><a href="#work" className="button button-primary">Explore selected work<ArrowDown size={15}/></a><TrackedLink href={resumeUrl} download={resumeFilename} event="resume_link" item="hero-resume" className="button button-secondary">Download résumé<ArrowDown size={14}/></TrackedLink><TrackedLink href="mailto:nayanak872@gmail.com" event="contact_open" item="hero-email" className="text-action">Contact<ArrowUpRight size={14}/></TrackedLink></div><ProofPanel/></div></section>
